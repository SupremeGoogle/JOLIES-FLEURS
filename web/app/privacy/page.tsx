        ...
        <div className="prose prose-sm max-w-none space-y-6" style={{ color: "#3D2B1F" }}>
          <section>
            ...
            <p className="opacity-70 leading-relaxed text-sm">
              ...
              персональных данных пользователей сайта joliesfleurs.ru (далее — «Сайт»), действующего на основании
              Федерального закона от 27.07.2006 № 152-ФЗ «О персональных данных».
            </p>
            <p className="opacity-70 leading-relaxed text-sm mt-2">
              Оператором персональных данных является ИП Jolies Fleurs, г. Москва (далее — «Оператор»).
            </p>
          </section>
          ...
          <section>
            ...
            <p className="opacity-70 leading-relaxed text-sm">
              ...
              Адрес: г. Москва, Ленинградский пр-кт, 29к4
            </p>
          </section>
          ...
          <section>
            ...
            <p className="opacity-70 leading-relaxed text-sm">
              ...
              в силу с момента её размещения на сайте. Продолжая пользоваться сайтом после изменений,
